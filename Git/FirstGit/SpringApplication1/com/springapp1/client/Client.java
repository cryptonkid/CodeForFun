...
public class Client {
	...
	public static void main(String[] args) {
		...
		BeanFactory factory = new XmlBeanFactory(new FileSystemResource("SpringApplication1/spring.xml"));
	...
	/*Note: After addding the plugin to create spring.xml we were able to run the file.*/
}
